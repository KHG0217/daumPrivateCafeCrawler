...
/**
 * snsContent 클래스를 대체하기 위한 클래스. snsContent에 없는 필드들을 추가하였음.
 * snsContent 클래스를 사용하는 코드는 snsContent2로 변경해야한다. snsContent는 점차 제거할 계획.
 * @author admin
 *
 */
public class SNSContent2 {
	private Long seq;
