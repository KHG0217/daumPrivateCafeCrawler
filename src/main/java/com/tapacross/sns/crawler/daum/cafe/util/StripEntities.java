...
// -------------------------- PUBLIC STATIC METHODS --------------------------
     ...
     *
     * @param possEntity string that may hold an entity. Lead & must be stripped, but may contain text past the ;
    ...
    public static char possEntityToChar( String possEntity ) {
        ...
        // find the trailing ;
        int whereSemi = possEntity.indexOf( ';', SHORTEST_ENTITY - 2/* where start looking */ );
    ...
    public static String stipHTMLTagAndEntities( String html ){
    	return stripEntities( stripHTMLTags(html) );
    }
    /**
